...
詳しくは [macOS アプリ](https://milmil.vercel.app/en/docs/getting-started/macos) を参照してください。
...
- **弾幕** — 弹弹play开放弹幕网络（DandanPlay） からの弾幕コメントオーバーレイ
...
| **弹弹play开放弹幕网络（DandanPlay）** | ファイルマッチング、弾幕コメント | 環境変数または設定画面 |
