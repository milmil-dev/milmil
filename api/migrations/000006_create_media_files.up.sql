CREATE TABLE IF NOT EXISTS media_files (
    id TEXT PRIMARY KEY,
    episode_id TEXT REFERENCES episodes(id) ON DELETE
    SET
        NULL,
...
CREATE INDEX IF NOT EXISTS idx_media_files_library_id_filename ON media_files(library_id, filename);

CREATE INDEX IF NOT EXISTS idx_media_files_library_id_match_status_filename ON media_files(library_id, match_status, filename);
